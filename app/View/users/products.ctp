...
<tr>
    <td class="paddingleft1"><input name="" type="button" value="Submit" class="submit_b"></td>
</tr>
<tr>
    <td>&nbsp;</td>
</tr>
...
<tr>
<td><select data-placeholder="Choose a Country..." class="chosen-select" multiple style="width:200px;" tabindex="4">
<option value=""></option>
...
<td valign="top">
    <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="altrowstable" id="alternatecolor">
                    <tr>
                        <th>Family</th>
                        ...
                        <th>Thread</th>
                        <th>Pitch</th>
                        <th>Diamension Series</th>
                    </tr>
                    <tr>
                        <td>111490</td>
                        <td>Socket Head Cap Screw 12.9 Black Full Thread Fine</td>
                        <td>12</td>
                        <td>40</td>
                        <td>200</td>
                        <td>avl</td>
